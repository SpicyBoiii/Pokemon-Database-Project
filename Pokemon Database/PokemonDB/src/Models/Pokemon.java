...
public class Pokemon {
	...
	public Pokemon( int p_id, String p_name, String p_ptype, String p_stype, int p_total, int p_hp, int p_attack,
			int p_defense, int p_sattack, int p_sdefense, int p_speed, String p_species) {
